...
router.get('/border', async function (req, res) {
    ...
    for(let i = 0; i < ps.length; i++) {
        let t = "<tr class='clickable-row' data-href='https://35.231.39.26:4000/users/getUser?id="+ps[i]._id+"'>\n" +
            "        <th class='align-middle' scope=\"row\">"+(i+1)+"</th>\n" +
            "        <td class='align-middle'><img src='https://35.231.39.26:4000/profile/"+ps[i].image+"' width='40px' height='40px'>"+("")+"</td>\n" +
